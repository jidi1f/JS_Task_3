window.onload = function() {
    ...
    {ratingRevievs:"1355 отзывов", price: "4 999 грн", name: "Samsung Galaxy J7 J700H/DSBlack + карта памяти 16гб + чехол + защитное стекло!"},
    {ratingRevievs:"426 отзывов", price: "5 199 грн", name: "Samsung Galaxy J5 (2016)J510H/DS Black + защитное стекло + чехол!"},
    {ratingRevievs: "403отзыва", price: "4 349 грн", name: "Xiaomi Redmi Note 4X 3/32GB Black"},
    {ratingRevievs: "488 отзывов", price: "6 199 грн", name: "Samsung GalaxyJ7 (2016) J710F/DS Gold + защитное стекло + чехол!"}, 
    ...
    {ratingRevievs: "709 отзывов", price: "2 799 грн", name: "Samsung Galaxy J1 2016 SM-J120H Black + защитноестекло + чехол!"},
    ...
    {ratingRevievs: "45 отзывов", price: "4 299 грн", name: "Nokia 3Dual Sim Silver White + сертификаты 500 грн!"},
    ...
    {ratingRevievs: "93 отзыва", price: "18 999 грн", name: "Apple iPhone 732GB Black"},
    {ratingRevievs: "33 отзыва", price: "16 999 грн", name: "Huawei P10 4/32GB Black + сертификат 2500грн + чехол Huawei SmartView Cover!"},
    ...
    {ratingRevievs: "156 отзывов", price: "2 599 грн", name: "Nous NS 5006Gold"},
    {ratingRevievs: "40 отзывов", price: "19 689 грн", name: "LG G6Mystic White"},
    {ratingRevievs: "24 отзыва", price: "5 995 грн", name:"Motorola MOTO G5 (XT1676) Grey"},
    {ratingRevievs: "7 отзывов", price:{oldUan: "10 999 грн", newUan: "9 999 грн"}, name: "HTC One X10 DualSim Silver"},
    {ratingRevievs: "18 отзывов", price: {oldUan: "5 999 грн",newUan: "4 999 грн"}, name: "Sony Xperia L1 Dual Black"}];
    
    function sortByPrice(arr) {
      let a1, b1;
      arr.sort(function(a, b) {
        if(a.price instanceof Object && typeof(b.price) == "string") { 
         a1 = +a.price.newUan.replace(/\D+/g,"");
         b1 = +b.price.replace(/\D+/g,"");

         if(a1 > b1) {console.log(typeof(a1)); return 1;}
         else return -1;
         }
        else if(b.price instanceof Object && typeof(a.price) == "string") { 
         a1 = +a.price.replace(/\D+/g,"");
         b1 = +b.price.newUan.replace(/\D+/g,"");

        if(a1 > b1) return 1;
        else return -1;
        }
        else if(a.price instanceof Object && b.price instanceof Object){
         a1 = +a.price.newUan.replace(/\D+/g,"");
         b1 = +b.price.newUan.replace(/\D+/g,"");
    ...
    for (key in arr[i]) {
      if(arr[i][key] instanceof Object)  cells += '<div class="cell">' +'<p>' +  arr[i][key].newUan +'<p>' + '</div>';
      
      else cells += '<div class="cell">' +'<p>' +  arr[i][key] +'<p>' + '</div>';
    }
